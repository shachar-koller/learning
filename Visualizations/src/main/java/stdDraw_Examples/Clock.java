...
public class Clock
{
    ...
    public static void main(String[] args)
    {
        ...
        int t = date.toLocalTime().toSecondOfDay();
        ...
        while (true) {
            ...
            double r1 = 0.4;
            StdDraw.line(0.5, 0.5, 0.5 + r1 * Math.sin(angle1),
            ...
            double r2 = 0.3;
            StdDraw.line(0.5, 0.5, 0.5 + r2 * Math.sin(angle2),
            ...
            double r3 = 0.2;
            StdDraw.line(0.5, 0.5, 0.5 + r3 * Math.sin(angle3),
            ...
            StdDraw.show();
            StdDraw.pause(1000);   // pause 1000 ms = 1 second
            t++;
        }
    } /* main */
